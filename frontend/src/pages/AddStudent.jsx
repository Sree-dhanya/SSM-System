...
const AddStudent = () => {
  ...
  const [studentForm, setStudentForm] = useState({
    ...
    blood_group: "",
    category: "", // NEW: Flattened Case Record Fields
      ...
      const fetchStudentForEdit = async () => {
        ...
        try {
          ...
          if (response.status === 404) {
            console.warn(
              `Student ${id} not found (404) — switching to create mode.`,
            );
  ...
  const handleFieldChange = (field) => (e) => {
    ...
    if (field === "aadhar_number") {
      ...
      else if (!/^[2-9]\d{11}$/.test(cleaned))
        setAadharError("Aadhaar must be 12 digits and start with 2-9.");
      else setAadharError("");
      return;
    }
  ...
  const handleMedicalConditionsChange = (condition) => (e) => {
    ...
    setStudentForm((prev) => {
      const conditions = prev.medical_conditions
        ? prev.medical_conditions.split(", ")
        : [];
      if (isChecked) {
  ...
  const saveStudent = async () => {
    ...
    const payload = {
      ...
      // class_teacher removed; teacher is derived from class_name + division
      ...
      family_history_mental_retardation:
        studentForm.family_history_mental_retardation,
    ...
    if (
      payload.disability_percentage !== undefined &&
      payload.disability_percentage !== null &&
      String(payload.disability_percentage).trim() !== ""
    ) {
      payload.disability_percentage =
        parseFloat(payload.disability_percentage) || null;
    } else {
    ...
    payload.drug_history = (payload.drug_history || []).filter(
      (r) =>
        (r.name && String(r.name).trim()) || (r.dose && String(r.dose).trim()),
    );
    payload.household = (payload.household || []).filter((r) =>
  ...
  useEffect(() => {
    if (studentForm.drug_history && Array.isArray(studentForm.drug_history)) {
      const rows = studentForm.drug_history.map((d, idx) => ({
        id: idx + 1,
        name: d.name || "",
        dose: d.dose || "",
      }));
  ...
  const selectClass =
    "w-full px-4 py-3 pr-8 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300 text-[#6F6C90]";
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-[#f7f7f7] relative py-20">
      ...
      <div className="text-center mb-12 z-10">
        ...
        <p className="text-[#6F6C8F] mt-2">Add a new student to the system</p>
      </div>
          ...
          {activeTab === "student-details" ? (
            <div className="bg-white/30 backdrop-blur-xl rounded-3xl shadow-xl p-8 md:p-12 border border-white/20 space-y-6">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-[#170F49] mb-6">
                    Personal Information
                  </h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex gap-3 items-center">
                        <div className="w-[70%]">
                          <select
                            ...
                            onChange={(e) => {
                              handleFieldChange("class_name")(e);
                              if (!e.target.value)
                                setStudentForm((prev) => ({
                                  ...prev,
                                  division: "",
                        ...
                        <div className="w-[30%]">
                          ...
                          <select
                            ...
                            disabled={!studentForm.class_name}
                          >
                            <option value="">Select</option>
                    ...
                    {/* Class Teacher removed; assignment derived from class + division */}
                    {/* Division is captured by the small dropdown beside Class Name; removed duplicate full-width input */}
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {[
                        ...
                        {
                          key: "pwd_registration",
                          label: "Person with Disability Registration",
                        },
                        {
                        ...
                        {
                          key: "hospital_assessment_report",
                          label: "Assessment Report from Hospital",
                        },
                        { key: "passbook", label: "Passbook" },
                        {
                          key: "nish_psychological_assessment",
                          label: "NISH Psychological Assessment Report",
                        },
                      ].map((doc) => (
                    ...
                    {Object.values(documents).some((doc) => doc !== null) && (
                      <div className="mt-6">
                        <h4 className="text-lg font-semibold text-[#170F49] mb-4">
                          Uploaded Documents
                        </h4>
                        <div className="bg-white/50 rounded-xl p-4 border border-[#E38B52]/20">
                          <ul className="space-y-2">
                            {[
                              ...
                              {
                                key: "ud_id",
                                label: "Unique Disability ID (UD ID)",
                              },
                              {
                                key: "hospital_assessment_report",
                                label: "Assessment Report from Hospital",
                                  ...
                                  >
                                    <div className="flex items-center gap-2">
                                      ...
                                      <span className="text-sm text-[#170F49]">
                                        {doc.label}: {documents[doc.key].name}
                                      </span>
                                    </div>
                                    <button
                                      type="button"
            ...
            <div
              className="flex gap-6 items-start justify-center relative max-w-[1600px] mx-auto"
              ref={mainContentRef}
            >
                  ...
                  <div className="bg-white/30 backdrop-blur-xl rounded-3xl shadow-xl p-8 md:p-12 border border-white/20">
                              ...
                              >
                                ...
                                <td className="px-4 py-3">
                                  <input
                                    ...
                                    value={row.name}
                                    onChange={(e) => {
                                      const updatedRows = householdRows.map(
                                        (r) =>
                                          r.id === row.id
                    ...
                    <div className="bg-white/30 backdrop-blur-xl rounded-2xl p-6 space-y-8 mb-8">
                      ...
                      >
                        ...
                        <span className="text-[#E38B52] font-medium">
                          Upload Pedigree Chart
                        </span>
                        <span className="block text-sm text-[#6F6C90] mt-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <textarea
                            className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300 resize-none"
                            rows="3"
                            placeholder="Enter psychological assessment"
                            value={studentForm.psychological_assessment}
                            onChange={handleFieldChange(
                              "psychological_assessment",
                            )}
                          ></textarea>
                        ...
                        <div>
                          ...
                          <textarea
                            className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300 resize-none"
                            rows="3"
                            placeholder="Enter medical examination"
                            value={studentForm.medical_examination}
                            onChange={handleFieldChange("medical_examination")}
                          ></textarea>
                        </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            value={studentForm.management_plan}
                            onChange={handleFieldChange("management_plan")}
                          ></textarea>
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="bg-white rounded-xl p-6 space-y-6 shadow-lg">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.dressing_removing_wearing}
                                onChange={handleFieldChange(
                                  "dressing_removing_wearing",
                                )}
                              />
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.dressing_buttoning}
                                onChange={handleFieldChange(
                                  "dressing_buttoning",
                                )}
                              />
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.dressing_footwear}
                                onChange={handleFieldChange(
                                  "dressing_footwear",
                                )}
                              />
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.dressing_grooming}
                                onChange={handleFieldChange(
                                  "dressing_grooming",
                                )}
                              />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white rounded-xl p-6 shadow-lg">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.gross_motor}
                              onChange={handleFieldChange("gross_motor")}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-[#170F49] mb-2">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.fine_motor}
                              onChange={handleFieldChange("fine_motor")}
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white/30 backdrop-blur-xl rounded-2xl p-6 space-y-8 mb-8">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-lg">
                          <input
                            ...
                            className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                            value={studentForm.sensory}
                            onChange={handleFieldChange("sensory")}
                          />
                        </div>
                      </div>
                    )}
                        ...
                        <div className="bg-white rounded-xl p-6 space-y-6 shadow-lg">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.language_communication}
                              onChange={handleFieldChange(
                                "language_communication",
                              )}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.social_behaviour}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.mobility_in_neighborhood}
                              onChange={handleFieldChange(
                                "mobility_in_neighborhood",
                              )}
                            />
                        ...
                        <div className="bg-white rounded-xl p-6 space-y-6 shadow-lg">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.attention}
                              onChange={handleFieldChange("attention")}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-[#170F49] mb-2">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.identification_of_objects}
                              onChange={handleFieldChange(
                                "identification_of_objects",
                              )}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.use_of_objects}
                              onChange={handleFieldChange("use_of_objects")}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-[#170F49] mb-2">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.following_instruction}
                              onChange={handleFieldChange(
                                "following_instruction",
                              )}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.awareness_of_danger}
                              onChange={handleFieldChange(
                                "awareness_of_danger",
                              )}
                            />
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.concept_color}
                                onChange={handleFieldChange("concept_color")}
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-[#170F49] mb-2">
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.concept_size}
                                onChange={handleFieldChange("concept_size")}
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-[#170F49] mb-2">
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.concept_sex}
                                onChange={handleFieldChange("concept_sex")}
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-[#170F49] mb-2">
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.concept_shape}
                                onChange={handleFieldChange("concept_shape")}
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-[#170F49] mb-2">
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.concept_number}
                                onChange={handleFieldChange("concept_number")}
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-[#170F49] mb-2">
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.concept_time}
                                onChange={handleFieldChange("concept_time")}
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-[#170F49] mb-2">
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                                value={studentForm.concept_money}
                                onChange={handleFieldChange("concept_money")}
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-6 space-y-6 shadow-lg">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.academic_reading}
                              onChange={handleFieldChange("academic_reading")}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-[#170F49] mb-2">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.academic_writing}
                              onChange={handleFieldChange("academic_writing")}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-[#170F49] mb-2">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.academic_arithmetic}
                              onChange={handleFieldChange(
                                "academic_arithmetic",
                              )}
                            />
                      ...
                      <div className="bg-white/30 backdrop-blur-xl rounded-2xl p-6 space-y-8 mb-8">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-lg">
                          <input
                            ...
                            className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                            value={studentForm.prevocational_ability}
                            onChange={handleFieldChange(
                              "prevocational_ability",
                            )}
                          />
                        ...
                        <div className="space-y-6">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.prevocational_interest}
                              onChange={handleFieldChange(
                                "prevocational_interest",
                              )}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                              value={studentForm.prevocational_dislike}
                              onChange={handleFieldChange(
                                "prevocational_dislike",
                              )}
                            />
                      ...
                      <div className="bg-white/30 backdrop-blur-xl rounded-2xl p-6 space-y-6 mb-8">
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            value={studentForm.any_peculiar_behaviour}
                            onChange={handleFieldChange(
                              "any_peculiar_behaviour",
                            )}
                          ></textarea>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            value={studentForm.any_other}
                            onChange={handleFieldChange("any_other")}
                          ></textarea>
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-[#170F49] mb-2">
                          ...
                          <textarea
                            ...
                            value={studentForm.recommendation}
                      ...
                      <div>
                        ...
                        <div className="mt-6 space-y-6">
                          <div>
                            ...
                            <input
                              type="text"
                              placeholder="Enter specific diagnostic details"
                              value={studentForm.specific_diagnostic}
                              onChange={handleFieldChange(
                                "specific_diagnostic",
                              )}
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                              ...
                              <label
                                key={item}
                                className="flex items-center space-x-3 bg-white p-4 rounded-xl border shadow-lg hover:[#E38B52]"
                              >
                                <input
                                  type="checkbox"
                                  className="w-4 h-4 rounded border-gray-300 text-[#E38B52] focus:ring-[#E38B52]"
                                  checked={
                                    studentForm.medical_conditions?.includes(
                                      item,
                                    ) || false
                                  }
                          ...
                          <div>
                            ...
                            <textarea
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300 resize-none"
                              rows="3"
                              placeholder="Enter other relevant medical information"
                              value={studentForm.medical_examination}
                              onChange={handleFieldChange(
                                "medical_examination",
                              )}
                                  ...
                                  >
                                    ...
                                    <td className="px-4 py-3">
                                      <input
                                        ...
                                        value={row.name}
                                        onChange={(e) => {
                                          const updatedRows = drugRows.map(
                                            (r) =>
                                              r.id === row.id
                                                ? { ...r, name: e.target.value }
                                                : r,
                        ...
                        <div className="mt-6 space-y-6">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              value={studentForm.drug_allergy}
                              onChange={handleFieldChange("drug_allergy")}
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                            />
                          </div>
                          <div>
                            ...
                            <input
                              ...
                              value={studentForm.food_allergy}
                              onChange={handleFieldChange("food_allergy")}
                              className="w-full px-4 py-3 rounded-xl border bg-white shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-[#E38B52] transition-all duration-300"
                            />
                          </div>
                        </div>
